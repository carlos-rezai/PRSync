...
| 7     | Refresh banner (conditional) | `MessageCard` (severity: info) with action                     | Appears only when background polling (15–30s) detects state drift. User must click to re-render — no silent live-patch               |
